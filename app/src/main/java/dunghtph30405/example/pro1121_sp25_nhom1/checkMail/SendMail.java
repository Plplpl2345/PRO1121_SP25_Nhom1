package dunghtph30405.example.pro1121_sp25_nhom1.checkMail;
...
public class SendMail {
    private final String username = "ngocdtph23108@fpt.edu.vn";
    private final String password = "ngocpachiu01";
